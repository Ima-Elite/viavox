<?php
/**
 * Template Name: Plantilla presentación
 *
 * Página para mostrar la sección presentación
 *
	...
	<div id="nav-pagina" class="container-fluid">
		<div class="container d-flex justify-content-between">
			...
			<?php
				wp_nav_menu(
					array(
						'theme_location' => 'presentacion-menu',
						'menu'           => 'menu-presentacion-es',
						'menu_id'        => 'menu-presentacion',
